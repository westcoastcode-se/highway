...
#ifdef __cplusplus
#define hiw_string_const(str)                                                                                          \
	{                                                                                                                  \
		str, hiw_string_const_len(str)                                                                                 \
	}
#else
#define hiw_string_const(str)                                                                                          \
	(hiw_string) { .begin = str, .length = hiw_string_const_len(str) }
#endif
...
/**
 * @brief Initialize memory on the heap with the supplied capacity. The memory will, automatically, resize itself
 * when needed
 * @param m
 * @param capacity
 * @return
