...
{
	if (hiw_string_cmp(suffix, hiw_string_const(".css"))) return hiw_mimetypes.text_css;
	if (hiw_string_cmp(suffix, hiw_string_const(".html"))) return hiw_mimetypes.text_html;
	if (hiw_string_cmp(suffix, hiw_string_const(".js"))) return hiw_mimetypes.text_javascript;
	if (hiw_string_cmp(suffix, hiw_string_const(".txt"))) return hiw_mimetypes.text_plain;

	if (hiw_string_cmp(suffix, hiw_string_const(".jpg"))) return hiw_mimetypes.image_jpeg;
	if (hiw_string_cmp(suffix, hiw_string_const(".jpeg"))) return hiw_mimetypes.image_jpeg;
	if (hiw_string_cmp(suffix, hiw_string_const(".png"))) return hiw_mimetypes.image_png;

	if (hiw_string_cmp(suffix, hiw_string_const(".json"))) return hiw_mimetypes.application_json;
